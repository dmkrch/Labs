...
class Parallelogram : public Figure
{
	public:
		...
		void scale_inc(int dx)
		{
			...
			set_first_y_coord(get_first_y_coord() + dx / 2);

			set_second_x_coord(get_second_x_coord() - dx);
			set_second_y_coord(get_second_y_coord() - dx / 2);

			set_third_x_coord(get_third_x_coord() + dx);
			set_third_y_coord(get_third_y_coord() - dx / 2);

			set_fourth_x_coord(get_fourth_x_coord() + dx);
			set_fourth_y_coord(get_fourth_y_coord() + dx / 2);
		}
